...
const Mission = () => {
  return (
    <section id="mission" className="py-16 bg-gradient-to-br from-secondary/30 via-white to-fin-blue/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-1/3">
            <div className="flex items-center gap-2 mb-4">
              <Globe className="h-6 w-6 text-primary animate-slide-down" />
          ...
          <div className="lg:w-2/3">
            <div className="h-full w-full bg-white rounded-xl shadow-xl overflow-hidden transform hover:scale-[1.02] transition-all duration-500 relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-fin-blue/30 to-fin-purple/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
              <img 
